...
def open_window():
    ...
    hide_button = Button(new, text="Hide Main Window",
                         command=root.withdraw).pack(pady=10)
    show_button = Button(new, text="Show Main Window",
                         command=root.deiconify).pack(pady=10)
    kill_original = Button(new, text="Quit Original",
